    ...
    private mockClasification: Clasification[] = [
        {
          ...
          properties: [
            { id: 101, name: 'Densidad', standardized_unit: 'kg/m3', min: 500, max: 8000 },
            { id: 102, name: 'Resistencia', standardized_unit: 'MPa', min: 50, max: 600 }
          ]
        },
        {
          clasification_id: 2,
          ...
          properties: [
            { id: 201, name: 'Longitud', standardized_unit: 'cm', min: 10, max: 200 }
          ]
        }
      ];
